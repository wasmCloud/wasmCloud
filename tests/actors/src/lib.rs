...
pub const RUST_BUILTINS_COMPAT_REACTOR: &str =
    concat!(env!("OUT_DIR"), "/rust-builtins-compat-reactor.wasm");
pub const RUST_BUILTINS_COMPAT_REACTOR_SIGNED: &str =
    concat!(env!("OUT_DIR"), "/rust-builtins-compat-reactor.signed.wasm");

pub const RUST_BUILTINS_COMPAT_REACTOR_PREVIEW2: &str = concat!(
    env!("OUT_DIR"),
    "/rust-builtins-compat-reactor-preview2.wasm"
);
pub const RUST_BUILTINS_COMPAT_REACTOR_PREVIEW2_SIGNED: &str = concat!(
    env!("OUT_DIR"),
    "/rust-builtins-compat-reactor-preview2.signed.wasm"
);
...
pub const RUST_HTTP_COMPAT_COMMAND: &str =
    concat!(env!("OUT_DIR"), "/rust-http-compat-command.wasm");
pub const RUST_HTTP_COMPAT_COMMAND_SIGNED: &str =
    concat!(env!("OUT_DIR"), "/rust-http-compat-command.signed.wasm");

pub const RUST_HTTP_COMPAT_COMMAND_PREVIEW2: &str =
    concat!(env!("OUT_DIR"), "/rust-http-compat-command-preview2.wasm");
pub const RUST_HTTP_COMPAT_COMMAND_PREVIEW2_SIGNED: &str = concat!(
    env!("OUT_DIR"),
    "/rust-http-compat-command-preview2.signed.wasm"
);
