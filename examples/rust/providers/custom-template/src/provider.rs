...
use crate::provider::exports::wasmcloud::example::system_info::Handler;
use crate::provider::exports::wasmcloud::example::system_info::Kind;
// The code generated by `wit-bindgen-wrpc` for your imports follow a pattern:
// crate::<world_name>::<namespace>::<package>::<interface>::*
use crate::provider::wasmcloud::example::process_data;
use crate::provider::wasmcloud::example::process_data::Data;
