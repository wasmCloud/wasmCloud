...
func PgValueReal(data HashableF64) PgValue {
	return cm.New[PgValue](12, data)
}

// Real returns a non-nil *[HashableF64] if [PgValue] represents the variant case "real".
func (self *PgValue) Real() *HashableF64 {
	return cm.Case[HashableF64](self, 12)
}

// PgValueFloat4 returns a [PgValue] of case "float4".
func PgValueFloat4(data HashableF64) PgValue {
	return cm.New[PgValue](13, data)
}

// Float4 returns a non-nil *[HashableF64] if [PgValue] represents the variant case "float4".
func (self *PgValue) Float4() *HashableF64 {
	return cm.Case[HashableF64](self, 13)
}

// PgValueFloat4Array returns a [PgValue] of case "float4-array".
func PgValueFloat4Array(data cm.List[HashableF64]) PgValue {
	return cm.New[PgValue](14, data)
}

// Float4Array returns a non-nil *[cm.List[HashableF64]] if [PgValue] represents the variant case "float4-array".
func (self *PgValue) Float4Array() *cm.List[HashableF64] {
	return cm.Case[cm.List[HashableF64]](self, 14)
}
...
// EUI-64 (deprecated)
// Geo
func PgValueBox(data cm.Tuple[Point, Point]) PgValue {
	return cm.New[PgValue](50, data)
}

// Box returns a non-nil *[cm.Tuple[Point, Point]] if [PgValue] represents the variant case "box".
func (self *PgValue) Box() *cm.Tuple[Point, Point] {
	return cm.Case[cm.Tuple[Point, Point]](self, 50)
}

// PgValueBoxArray returns a [PgValue] of case "box-array".
func PgValueBoxArray(data cm.List[cm.Tuple[Point, Point]]) PgValue {
	return cm.New[PgValue](51, data)
}

// BoxArray returns a non-nil *[cm.List[cm.Tuple[Point, Point]]] if [PgValue] represents the variant case "box-array".
func (self *PgValue) BoxArray() *cm.List[cm.Tuple[Point, Point]] {
	return cm.Case[cm.List[cm.Tuple[Point, Point]]](self, 51)
}

// PgValueCircle returns a [PgValue] of case "circle".
func PgValueCircle(data cm.Tuple[Point, HashableF64]) PgValue {
	return cm.New[PgValue](52, data)
}

// Circle returns a non-nil *[cm.Tuple[Point, HashableF64]] if [PgValue] represents the variant case "circle".
func (self *PgValue) Circle() *cm.Tuple[Point, HashableF64] {
	return cm.Case[cm.Tuple[Point, HashableF64]](self, 52)
}

// PgValueCircleArray returns a [PgValue] of case "circle-array".
func PgValueCircleArray(data cm.List[cm.Tuple[Point, HashableF64]]) PgValue {
	return cm.New[PgValue](53, data)
}

// CircleArray returns a non-nil *[cm.List[cm.Tuple[Point, HashableF64]]] if [PgValue] represents the variant case "circle-array".
func (self *PgValue) CircleArray() *cm.List[cm.Tuple[Point, HashableF64]] {
	return cm.Case[cm.List[cm.Tuple[Point, HashableF64]]](self, 53)
}

// PgValueLine returns a [PgValue] of case "line".
func PgValueLine(data cm.Tuple[Point, Point]) PgValue {
	return cm.New[PgValue](54, data)
}

// Line returns a non-nil *[cm.Tuple[Point, Point]] if [PgValue] represents the variant case "line".
func (self *PgValue) Line() *cm.Tuple[Point, Point] {
	return cm.Case[cm.Tuple[Point, Point]](self, 54)
}

// PgValueLineArray returns a [PgValue] of case "line-array".
func PgValueLineArray(data cm.List[cm.Tuple[Point, Point]]) PgValue {
	return cm.New[PgValue](55, data)
}

// LineArray returns a non-nil *[cm.List[cm.Tuple[Point, Point]]] if [PgValue] represents the variant case "line-array".
func (self *PgValue) LineArray() *cm.List[cm.Tuple[Point, Point]] {
	return cm.Case[cm.List[cm.Tuple[Point, Point]]](self, 55)
}

// PgValueLseg returns a [PgValue] of case "lseg".
func PgValueLseg(data cm.Tuple[Point, Point]) PgValue {
	return cm.New[PgValue](56, data)
}

// Lseg returns a non-nil *[cm.Tuple[Point, Point]] if [PgValue] represents the variant case "lseg".
func (self *PgValue) Lseg() *cm.Tuple[Point, Point] {
	return cm.Case[cm.Tuple[Point, Point]](self, 56)
}

// PgValueLsegArray returns a [PgValue] of case "lseg-array".
func PgValueLsegArray(data cm.List[cm.Tuple[Point, Point]]) PgValue {
	return cm.New[PgValue](57, data)
}

// LsegArray returns a non-nil *[cm.List[cm.Tuple[Point, Point]]] if [PgValue] represents the variant case "lseg-array".
func (self *PgValue) LsegArray() *cm.List[cm.Tuple[Point, Point]] {
	return cm.Case[cm.List[cm.Tuple[Point, Point]]](self, 57)
}
