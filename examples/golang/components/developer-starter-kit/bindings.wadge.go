...
import (
	...
	github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__atomics "github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/atomics"
	github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store "github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store"
	github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasmcloud__messaging__consumer "github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasmcloud/messaging/consumer"
	github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasmcloud__messaging__types "github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasmcloud/messaging/types"
...
//go:linkname wasmimport_Increment github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/atomics.wasmimport_Increment
func wasmimport_Increment(bucket0 uint32, key0 *uint8, key1 uint32, delta0 uint64, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__atomics.ErrorShape, uint64, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
...
//go:linkname wasmimport_BucketDelete github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_BucketDelete
func wasmimport_BucketDelete(self0 uint32, key0 *uint8, key1 uint32, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error, struct{}, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
...
//go:linkname wasmimport_BucketExists github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_BucketExists
func wasmimport_BucketExists(self0 uint32, key0 *uint8, key1 uint32, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.ErrorShape, bool, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
...
//go:linkname wasmimport_BucketGet github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_BucketGet
func wasmimport_BucketGet(self0 uint32, key0 *uint8, key1 uint32, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.OptionListU8Shape, github_com__bytecodealliance__wasm___tools___go__cm.Option[github_com__bytecodealliance__wasm___tools___go__cm.List[uint8]], github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
...
//go:linkname wasmimport_BucketListKeys github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_BucketListKeys
func wasmimport_BucketListKeys(self0 uint32, cursor0 uint32, cursor1 uint64, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.KeyResponseShape, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.KeyResponse, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
...
//go:linkname wasmimport_BucketSet github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_BucketSet
...
//go:linkname wasmimport_BucketResourceDrop github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_BucketResourceDrop
...
//go:linkname wasmimport_Open github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasi/keyvalue/store.wasmimport_Open
func wasmimport_Open(identifier0 *uint8, identifier1 uint32, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.ErrorShape, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Bucket, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasi__keyvalue__store.Error]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
...
//go:linkname wasmimport_Publish github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasmcloud/messaging/consumer.wasmimport_Publish
...
//go:linkname wasmimport_Request github.com/wasmCloud/wasmcloud/examples/golang/components/developer-starter-kit/gen/wasmcloud/messaging/consumer.wasmimport_Request
func wasmimport_Request(subject0 *uint8, subject1 uint32, body0 *uint8, body1 uint32, timeoutMs0 uint32, result *github_com__bytecodealliance__wasm___tools___go__cm.Result[github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasmcloud__messaging__consumer.BrokerMessageShape, github_com__wasmCloud__wasmcloud__examples__golang__components__developer___starter___kit__gen__wasmcloud__messaging__types.BrokerMessage, string]) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
