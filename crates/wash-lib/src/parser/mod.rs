...
use wasm_pkg_client::{CustomConfig, Registry, RegistryMapping};
...
impl TryFrom<RegistryPullSource> for RegistryMapping {
    ...
    fn try_from(value: RegistryPullSource) -> Result<Self> {
        match value {
            ...
            // For remote OCI images we expect to receive an 'oci://' prefixed string which essentially functions as a URL
