...
<csr-read-only-do-not-edit/>
 ...
 - 78 commits contributed to the release over the course of 816 calendar days.
 ...
 * **Uncategorized**
    ...
    - Define mod trace when enable feature otel ([`6e185b5`](https://github.com/wasmCloud/wasmCloud/commit/6e185b5cb47c0b5aece0c694013194cc93fda30c))
    - Fix fmt ([`a2dafbb`](https://github.com/wasmCloud/wasmCloud/commit/a2dafbb7490670c137b11eb4c4475d31ee2b0371))
    - Fix not valid context ([`d2a5b48`](https://github.com/wasmCloud/wasmCloud/commit/d2a5b48fb89d6f424b2095fa3969d649371d860d))
    - Support http outgoing injector ([`b2ab482`](https://github.com/wasmCloud/wasmCloud/commit/b2ab482dd5271b82f47f72e7f325d9b70a6db2a4))
    - Fix build ([`68d2a9d`](https://github.com/wasmCloud/wasmCloud/commit/68d2a9d0bf60694b9bf659d9e86c938a83a50748))
    - Propagate trace from incoming HTTP and to outgoing HTTP ([`23cca0e`](https://github.com/wasmCloud/wasmCloud/commit/23cca0ef59e7f323f62d2a119871e6fcff7d0f4a))
