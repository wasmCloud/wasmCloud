...
pub struct WasmcloudOpts {
    ...
    /// A CA file to use to authenticate to NATS for RPC messages
    #[clap(long = "rpc-ca-file", env = WASMCLOUD_RPC_TLS_CA_FILE)]
    ...
    /// A CA file to use to authenticate to NATS for CTL messages
    #[clap(long = "ctl-ca-file", env = WASMCLOUD_CTL_TLS_CA_FILE)]
