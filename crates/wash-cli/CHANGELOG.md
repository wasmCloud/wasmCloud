...
<csr-unknown>
Delete all undeployed applicationsBackwards compatibility with millisecond input still maintainedImproved terminal handling while watching application latticewatch interval for ‘app list’ is now configurable with a default interval of 1000ms.Added Short flag of -w as an alternative to –watch<csr-unknown/>
