...
### Chore
 ...
 - <csr-id-0672c35df183152890751bb1d4dc365c0093c49d/> Address clippy feedback
...
<csr-read-only-do-not-edit/>
 ...
 - 102 commits contributed to the release.
 ...
 * **Uncategorized**
    - Address clippy feedback ([`0672c35`](https://github.com/vados-cosmonic/wasmCloud/commit/0672c35df183152890751bb1d4dc365c0093c49d))
    - Removes dependencies from host on provider libraries ([`c36dee9`](https://github.com/vados-cosmonic/wasmCloud/commit/c36dee94832d111c2a3ba5ff9f5e26baf2f3e4d9))
    - Bump provider-archive v0.16.0, wasmcloud-core v0.17.0, wasmcloud-tracing v0.13.0, wasmcloud-provider-sdk v0.14.0, wasmcloud-provider-http-server v0.27.0, wasmcloud-provider-messaging-nats v0.26.0, wasmcloud-runtime v0.9.0, wasmcloud-secrets-types v0.6.0, wasmcloud-secrets-client v0.7.0, wasmcloud-host v0.25.0, wasmcloud-test-util v0.17.0, secrets-nats-kv v0.2.0, wash v0.41.0 ([`3078c88`](https://github.com/vados-cosmonic/wasmCloud/commit/3078c88f0ebed96027e20997bccc1c125583fad4))
    - Updates dependencies ([`5f7e013`](https://github.com/vados-cosmonic/wasmCloud/commit/5f7e0132362f7eda0710a1a69d5944140fd74b07))
    - Rework http-client using http/1.1 and `hyper` directly ([`732528c`](https://github.com/vados-cosmonic/wasmCloud/commit/732528c9176adc6a9429b76716f68608a817ccf9))
    - Bump wasmcloud-core v0.16.0, wash-lib v0.32.0, wash-cli v0.38.0, safety bump 6 crates ([`4f30198`](https://github.com/vados-cosmonic/wasmCloud/commit/4f30198215220b3f9ce0c2aa6da8aa7d31a6a72d))
    - Adds the ability to configure sampling and buffer size ([`f051d9d`](https://github.com/vados-cosmonic/wasmCloud/commit/f051d9d3b8afb0ea1baafd87941babb29830fe4d))
    - Removed unused dependencies ([`eb52eca`](https://github.com/vados-cosmonic/wasmCloud/commit/eb52eca817fe24b33e7f1a65c1ba5c46c50bef4e))
    - Bump wascap v0.15.2, provider-archive v0.14.0, wasmcloud-core v0.15.0, wash-lib v0.31.0, wasmcloud-tracing v0.11.0, wasmcloud-provider-sdk v0.12.0, wasmcloud-secrets-types v0.5.0, wash-cli v0.37.0, safety bump 9 crates ([`ef45f59`](https://github.com/vados-cosmonic/wasmCloud/commit/ef45f597710929d41be989110fc3c51621c9ee62))
    - Fixes issue with provider cache invalidation ([`57efd50`](https://github.com/vados-cosmonic/wasmCloud/commit/57efd505aebe0f9805221449b7ef3e8557370721))
    - Bump wascap v0.15.1, wasmcloud-core v0.13.0, wash-lib v0.29.0, wasmcloud-tracing v0.10.0, wasmcloud-provider-sdk v0.11.0, wash-cli v0.36.0, safety bump 7 crates ([`c5ba85c`](https://github.com/vados-cosmonic/wasmCloud/commit/c5ba85cfe6ad63227445b0a5e21d58a8f3e15e33))
    - Improve parse_wit_package_name handling ([`db94b15`](https://github.com/vados-cosmonic/wasmCloud/commit/db94b15b82f041bd80026c6f3dcf5e5102701e38))
    - V0.12.1 ([`18dccc3`](https://github.com/vados-cosmonic/wasmCloud/commit/18dccc362462cc70e82720bb4cb818bda9ae5b12))
    - Allow missing registry authentication ([`86863ee`](https://github.com/vados-cosmonic/wasmCloud/commit/86863ee2ed2e0bb8c2c39844baff5cb8a17119fd))
    - Updates tests and examples to support the new wkg deps ([`f0f3fd7`](https://github.com/vados-cosmonic/wasmCloud/commit/f0f3fd7011724137e5f8a4c47a8e4e97be0edbb2))
    - Add checked set_link_name ([`5f05bcc`](https://github.com/vados-cosmonic/wasmCloud/commit/5f05bcc468b3e67e67a22c666d93176b44164fbc))
    - Fix tests, update parsing of advanced WIT package names ([`ea814a1`](https://github.com/vados-cosmonic/wasmCloud/commit/ea814a1603d9d2ac7173c729024ba2834d97f45b))
    - Bump wasmcloud-core v0.12.0, wash-lib v0.28.0, wasmcloud-tracing v0.9.0, wasmcloud-provider-sdk v0.10.0, wash-cli v0.35.0, safety bump 7 crates ([`44bf4c8`](https://github.com/vados-cosmonic/wasmCloud/commit/44bf4c8793b3989aebbbc28c2f2ce3ebbd4d6a0a))
    - Revert OtelProtocol rename, add future compatibility aliasing ([`b8d2293`](https://github.com/vados-cosmonic/wasmCloud/commit/b8d229303bc1f8d1e0983cb5066f7b08bd961bbc))
    - Wasmcloud-core v0.11.0 ([`e3c9676`](https://github.com/vados-cosmonic/wasmCloud/commit/e3c96762bda98efeb49bc67605d09453dadaa9ce))
    - Rename OtelProtocol variants to lowercase ([`5aebf9b`](https://github.com/vados-cosmonic/wasmCloud/commit/5aebf9bab8b3dfdcb65342c549e8700138ab381f))
    - Skip serializing Option fields if set to None ([`8676d12`](https://github.com/vados-cosmonic/wasmCloud/commit/8676d12373f238286606b17ba7918b308f2144be))
    - Use Default impl for Level ([`ebe8ba9`](https://github.com/vados-cosmonic/wasmCloud/commit/ebe8ba9c7984a158c2c7e787bf02a420be62c530))
    - Remove redundant `tower` dep ([`c205148`](https://github.com/vados-cosmonic/wasmCloud/commit/c205148b7f67ab5e80edbae46489083fcb665f99))
    - Prep for upgrade to rustls_native_certs v0.8.0 ([`842b1c0`](https://github.com/vados-cosmonic/wasmCloud/commit/842b1c0f24c78ab5b891be204675748750387424))
    - Bump wasmcloud-core v0.10.0, safety bump 5 crates ([`1af6e05`](https://github.com/vados-cosmonic/wasmCloud/commit/1af6e05f1a47be4e62a4c21d1704aff2e09bef89))
    - Switch oci-distribution to oci feature ([`d26c69a`](https://github.com/vados-cosmonic/wasmCloud/commit/d26c69a22749bc92b8bfd2f4c93d0c9d3cc744ba))
    - Re-add missing cache code ([`caa9e41`](https://github.com/vados-cosmonic/wasmCloud/commit/caa9e41b302571c864c56733f3a119da8a2a9a57))
    - Add missing feature for `oci-wasm` ([`21d0601`](https://github.com/vados-cosmonic/wasmCloud/commit/21d0601b066a29a8b8f182c26372a0adeea290eb))
    - Move functionality into core ([`0547e3a`](https://github.com/vados-cosmonic/wasmCloud/commit/0547e3a429059b15ec969a0fa36d7823a6b7331f))
    - Bump wasmcloud-core v0.9.0, wash-lib v0.24.0, wasmcloud-tracing v0.7.0, wasmcloud-provider-sdk v0.8.0, wasmcloud-secrets-types v0.4.0, wash-cli v0.31.0, safety bump 5 crates ([`8403350`](https://github.com/vados-cosmonic/wasmCloud/commit/8403350432a2387d4a2bce9c096f002005ba54be))
    - Add RPC subject for provider config updates ([`02d8865`](https://github.com/vados-cosmonic/wasmCloud/commit/02d88655045d7e620c2452b7d7689cede4ad12db))
    - Bump for test-util release ([`7cd2e71`](https://github.com/vados-cosmonic/wasmCloud/commit/7cd2e71cb82c1e1b75d0c89bd5bda343016e75f4))
    - Add string and byte utility functions for SecretValue ([`4ffee2e`](https://github.com/vados-cosmonic/wasmCloud/commit/4ffee2ed95985902071cbdbf8300dba8e2c37d81))
    - Efficiency, pass optional vec secrets ([`cfbf232`](https://github.com/vados-cosmonic/wasmCloud/commit/cfbf23226f34f3e7245a5d36cd7bb15e1796850c))
    - Impl Zeroize for secret values ([`10e5d70`](https://github.com/vados-cosmonic/wasmCloud/commit/10e5d702d940a4c36dff542d21c6f56f6c7cb28f))
    - Add hostdata xkeys, secrets as binary ([`9045597`](https://github.com/vados-cosmonic/wasmCloud/commit/9045597210b60ea842a91a99d549d58d6440f660))
    - Light refactor from PR followup ([`5a6fdbd`](https://github.com/vados-cosmonic/wasmCloud/commit/5a6fdbda50d91f23c3fc6ea2b28dfe55edd46217))
    - Remove extra trace_level field ([`4e1d6da`](https://github.com/vados-cosmonic/wasmCloud/commit/4e1d6da189ff49790d876cd244aed89114efba98))
    - Add trace_level option ([`3bd9da5`](https://github.com/vados-cosmonic/wasmCloud/commit/3bd9da571cb2a700cbb9a4966d805664a762d9a0))
    - Add support for supplying additional CA certificates to OCI and OpenTelemetry clients ([`24e77b7`](https://github.com/vados-cosmonic/wasmCloud/commit/24e77b7f1f29580ca348a758302cdc6e75cc3afd))
    - Fetch secrets for providers and links ([`e0324d6`](https://github.com/vados-cosmonic/wasmCloud/commit/e0324d66e49be015b7b231626bc3b619d9374c91))
    - Add secrets to hostdata and links ([`724b079`](https://github.com/vados-cosmonic/wasmCloud/commit/724b079ef76491e7b030e7db248a2a8364258154))
    - Upgrade `wrpc`, `async-nats`, `wasmtime` ([`9cb1b78`](https://github.com/vados-cosmonic/wasmCloud/commit/9cb1b784fe7a8892d73bdb40d1172b1879fcd932))
    - Add README and update docs ([`48f6307`](https://github.com/vados-cosmonic/wasmCloud/commit/48f6307da226a48969d3d08188db89d3d8069495))
    - Bump wascap v0.15.0, wasmcloud-core v0.7.0, wash-lib v0.22.0, wasmcloud-tracing v0.5.0, wasmcloud-provider-sdk v0.6.0, wash-cli v0.29.0, safety bump 5 crates ([`2e38cd4`](https://github.com/vados-cosmonic/wasmCloud/commit/2e38cd45adef18d47af71b87ca456a25edb2f53a))
    - Add signal-specific path components to OtelConfig's default endpoints ([`56807ae`](https://github.com/vados-cosmonic/wasmCloud/commit/56807ae5d0f6bbddb12f0e22d58a3d84fdb4f48c))
    - Default to http otel protocol if not supplied ([`825ef3a`](https://github.com/vados-cosmonic/wasmCloud/commit/825ef3a28cbdf49727b902a0a8d5e43aa502c522))
    - Add support for configuring grpc protocol with opentelemetry ([`378b7c8`](https://github.com/vados-cosmonic/wasmCloud/commit/378b7c89c8b00a5dcee76c06bc8de615dc58f8aa))
    - Configure reqwest with user-agent ([`ac8f773`](https://github.com/vados-cosmonic/wasmCloud/commit/ac8f773abc171d4083ae5d266c9e9efdf1a0af59))
    - Replace actor references by component in crates ([`20c72ce`](https://github.com/vados-cosmonic/wasmCloud/commit/20c72ce0ed423561ae6dbd5a91959bec24ff7cf3))
    - Bump provider-archive v0.10.2, wasmcloud-core v0.6.0, wash-lib v0.21.0, wasmcloud-tracing v0.4.0, wasmcloud-provider-sdk v0.5.0, wash-cli v0.28.0 ([`73c0ef0`](https://github.com/vados-cosmonic/wasmCloud/commit/73c0ef0bbe2f6b525655939d2cd30740aef4b6bc))
    - Compile with default features ([`8fc13bf`](https://github.com/vados-cosmonic/wasmCloud/commit/8fc13bfee8927e9002014ead06762c8a32ed4356))
    - Bump provider-archive v0.10.1, wasmcloud-core v0.6.0, wash-lib v0.21.0, wasmcloud-tracing v0.4.0, wasmcloud-provider-sdk v0.5.0, wash-cli v0.28.0, safety bump 5 crates ([`75a2e52`](https://github.com/vados-cosmonic/wasmCloud/commit/75a2e52f52690ba143679c90237851ebd07e153f))
    - Generate changelogs after 1.0.1 release ([`4e0313a`](https://github.com/vados-cosmonic/wasmCloud/commit/4e0313ae4cfb5cbb2d3fa0320c662466a7082c0e))
    - Updated with newest features ([`0f03f1f`](https://github.com/vados-cosmonic/wasmCloud/commit/0f03f1f91210a4ed3fa64a4b07aebe8e56627ea6))
    - Generate crate changelogs ([`f986e39`](https://github.com/vados-cosmonic/wasmCloud/commit/f986e39450676dc598b92f13cb6e52b9c3200c0b))
    - Address clippy warnings ([`5957fce`](https://github.com/vados-cosmonic/wasmCloud/commit/5957fce86a928c7398370547d0f43c9498185441))
    - Remove cluster_seed/cluster_issuers ([`bc5d296`](https://github.com/vados-cosmonic/wasmCloud/commit/bc5d296f3a58bc5e8df0da7e0bf2624d03335d9f))
    - Return wrapped `WrpcClient` directly ([`87eb6c8`](https://github.com/vados-cosmonic/wasmCloud/commit/87eb6c8b2c0bd31def1cfdc6121c612c4dc90871))
    - Excises vestigal remains of wasmbus-rpc ([`fd69df4`](https://github.com/vados-cosmonic/wasmCloud/commit/fd69df40f24ca565ace0f8c97a0c47a89db575a4))
    - Remove LinkDefinition ([`8e7d6c8`](https://github.com/vados-cosmonic/wasmCloud/commit/8e7d6c80b56e143bb09dc441e8b21104328d0ab0))
    - Adds version to control API ([`3f2d2f4`](https://github.com/vados-cosmonic/wasmCloud/commit/3f2d2f44470d44809fb83de2fa34b29ad1e6cb30))
    - Introduce provider interface sdk ([`a84492d`](https://github.com/vados-cosmonic/wasmCloud/commit/a84492d15d154a272de33680f6338379fc036a3a))
    - Use native TLS roots along webpki ([`07b5e70`](https://github.com/vados-cosmonic/wasmCloud/commit/07b5e70a7f1321d184962d7197a8d98d1ecaaf71))
    - Move wasmbus RPC topic generation to core ([`5d73831`](https://github.com/vados-cosmonic/wasmCloud/commit/5d7383137897d28a1bc5df9b1c48f75281dab55b))
    - Fix `link_name` functionality, reorganize tests ([`4ed3891`](https://github.com/vados-cosmonic/wasmCloud/commit/4ed38913f19fcd4dd44dfdcc9007e80e80cdc960))
    - Bump to 0.3 ([`95233cb`](https://github.com/vados-cosmonic/wasmCloud/commit/95233cbade898a8b17df2fec3d6aed8ce8ceca2a))
    - Implement Redis `wrpc:keyvalue/{atomic,eventual}` ([`614af7e`](https://github.com/vados-cosmonic/wasmCloud/commit/614af7e3ed734c56b27cd1d2aacb0789a85e8b81))
    - Implement `wasi:http/outgoing-handler` provider ([`e0dac9d`](https://github.com/vados-cosmonic/wasmCloud/commit/e0dac9de4d3a74424e3138971753db9da143db5a))
    - Deliver full config with link ([`e14d040`](https://github.com/vados-cosmonic/wasmCloud/commit/e14d0405e9f746041001e101fc24320c9e6b4f9c))
    - Update wRPC ([`95cfb6d`](https://github.com/vados-cosmonic/wasmCloud/commit/95cfb6d99f0e54243b2fb2618de39210d8f3694f))
    - Pass config directly to providers ([`7fbd597`](https://github.com/vados-cosmonic/wasmCloud/commit/7fbd597546c0ae25d5ce981b716167e4cc01263c))
    - Remove LatticeTargetId ([`5ed5367`](https://github.com/vados-cosmonic/wasmCloud/commit/5ed5367063e39f890dabafdc476ea2370d32aae7))
    - Use `&str` directly ([`6b369d4`](https://github.com/vados-cosmonic/wasmCloud/commit/6b369d49cd37a87dca1f92f31c4d4d3e33dec501))
    - Use traces instead of tracing user-facing language to align with OTEL signal names ([`d65512b`](https://github.com/vados-cosmonic/wasmCloud/commit/d65512b5e86eb4d13e64cffa220a5a842c7bb72b))
    - Add flags for overriding the default OpenTelemetry endpoint ([`6fe14b8`](https://github.com/vados-cosmonic/wasmCloud/commit/6fe14b89d4c26e5c01e54773268c6d0f04236e71))
    - Switch to using --enable-observability and --enable-<signal> flags ([`868570b`](https://github.com/vados-cosmonic/wasmCloud/commit/868570be8d94a6d73608c7cde5d2422e15f9eb0c))
    - Move CallTargetInterface to core ([`0d90023`](https://github.com/vados-cosmonic/wasmCloud/commit/0d9002340ca8776c92a7d1e8b2caa4f804bb1bfb))
    - Correct comment on wrpc Client ([`dc2c93d`](https://github.com/vados-cosmonic/wasmCloud/commit/dc2c93df97bb119bb2a024d5bd3458394f421792))
    - Get values from new link def constistently ([`b6a6b04`](https://github.com/vados-cosmonic/wasmCloud/commit/b6a6b04229730d6783c3fee61c6e078cd3b962ef))
    - Move wasmcloud wrpc transport client to core ([`c654448`](https://github.com/vados-cosmonic/wasmCloud/commit/c654448653db224c6a676ecf43150d880a9daf8c))
    - Support pubsub on wRPC subjects ([`76c1ed7`](https://github.com/vados-cosmonic/wasmCloud/commit/76c1ed7b5c49152aabd83d27f0b8955d7f874864))
    - InterfaceLinkDefinition -> core ([`c49a6ef`](https://github.com/vados-cosmonic/wasmCloud/commit/c49a6ef0b6460b3eb463315fe31878eb71ae5364))
    - Change set-target to set-link-name ([`5d19ba1`](https://github.com/vados-cosmonic/wasmCloud/commit/5d19ba16a98dca9439628e8449309ccaa763ab10))
    - Updates topics to the new standard ([`42d069e`](https://github.com/vados-cosmonic/wasmCloud/commit/42d069eee87d1b5befff1a95b49973064f1a1d1b))
    - Bump to 0.2.0 for async-nats release ([`6abbcac`](https://github.com/vados-cosmonic/wasmCloud/commit/6abbcac954a9834d871ea69b8a40bd79d258c0f1))
    - Convert httpclient provider to bindgen ([`123e536`](https://github.com/vados-cosmonic/wasmCloud/commit/123e53611e6d0b2bd4e92358783213784653fbf6))
    - Address clippy issues ([`eb0599f`](https://github.com/vados-cosmonic/wasmCloud/commit/eb0599fbdc6e1ac58616c7676b89bf7b19d4c662))
    - Clean-up imports ([`7402a1f`](https://github.com/vados-cosmonic/wasmCloud/commit/7402a1f5cc4515e270fa66bbdd3d8bf2c03f35cb))
    - Add descriptions to crates ([`cb0bcab`](https://github.com/vados-cosmonic/wasmCloud/commit/cb0bcab822cb4290c673051ec1dd98d034a61546))
    - Remove direct `wasmbus_rpc` dependency ([`8e071dd`](https://github.com/vados-cosmonic/wasmCloud/commit/8e071dde1a98caa7339e92882bb63c433ae2a042))
    - Replace error field name with err ([`3ffbd3a`](https://github.com/vados-cosmonic/wasmCloud/commit/3ffbd3ae2770a2bb7ef2d5635489e2725b3d9daa))
    - Allow namespaces with slashes ([`1829b27`](https://github.com/vados-cosmonic/wasmCloud/commit/1829b27213e836cb347a542e9cdc771c74427892))
    - Include context on host errors ([`0e6e2da`](https://github.com/vados-cosmonic/wasmCloud/commit/0e6e2da7720e469b85940cadde3756b2afd64f7c))
    - Look for invocation responses from providers ([`7502bcb`](https://github.com/vados-cosmonic/wasmCloud/commit/7502bcb569420e2d402bf66d8a5eff2e6481a80b))
    - Enable `std` anyhow feature ([`a896f05`](https://github.com/vados-cosmonic/wasmCloud/commit/a896f05a35824f5e2ba16fdb1c1f5217c52a5388))
    - Make content_length a required field ([`6428747`](https://github.com/vados-cosmonic/wasmCloud/commit/642874717b6aab760d4692f9e8b12803548314e2))
    - Replace needs_chunking function with direct comparison ([`6de67aa`](https://github.com/vados-cosmonic/wasmCloud/commit/6de67aa1ddab22ec99fe70f2c2fdc92dc5760b06))
    - Support chunking and dechunking of requests ([`813ce52`](https://github.com/vados-cosmonic/wasmCloud/commit/813ce52a9c11270814eec051dfaa8817bf9f567d))
    - Move chunking to core ([`0319a92`](https://github.com/vados-cosmonic/wasmCloud/commit/0319a9245589709d96b03786374d8026beb5d5d0))
    - Support OTEL traces end-to-end ([`675d364`](https://github.com/vados-cosmonic/wasmCloud/commit/675d364d2f53f9dbf7ebb6c655d5fbbbba6c62b6))
</details>
