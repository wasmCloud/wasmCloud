...
<csr-read-only-do-not-edit/>
 ...
 - 89 commits contributed to the release over the course of 749 calendar days.
 - 1670 days passed between releases.
 ...
 * **Uncategorized**
    ...
    - Bump control-interface to 2.4.0 for release ([`e7554f3`](https://github.com/wasmCloud/wasmCloud/commit/e7554f3fa94bc0724164ed911a8d5f5d0196fd27))
    ...
    - Bump control-interface v2.3.0 ([`08f5cd0`](https://github.com/wasmCloud/wasmCloud/commit/08f5cd031e3d4f0c0ab0ddc497f7cb099276b2a5))
    ...
    - Retain string aliases for semver ([`f1cfdf3`](https://github.com/wasmCloud/wasmCloud/commit/f1cfdf36429be5fcbb5db8e5014b8ce53bb44349))
    ...
    - Wasmcloud-control-interface v2.2.0 ([`45b6655`](https://github.com/wasmCloud/wasmCloud/commit/45b6655bb21c6b9a3005babf771131a56d2c5e8a))
    - Wrong data returned from provider auction ([`1e6cd4f`](https://github.com/wasmCloud/wasmCloud/commit/1e6cd4fd79e2270adea8cba00261028d4d53d3ab))
    - Wasmcloud-control-interface v2.1.0 ([`a753015`](https://github.com/wasmCloud/wasmCloud/commit/a75301563346bcc0ae458e20ca25e577380e733f))
    - Builder-ize ProviderDescription ([`0785e83`](https://github.com/wasmCloud/wasmCloud/commit/0785e8374dbd843250af60a19da9ae5d5b340622))
    - Control-interface v2.0.0 ([`b40df26`](https://github.com/wasmCloud/wasmCloud/commit/b40df26032b9f653ab3f3e60f7a34f1bea6c95df))
    - Prep for v2 release ([`8b369e7`](https://github.com/wasmCloud/wasmCloud/commit/8b369e7bd068a1cf2b4d034dcc287c657d1ae8d1))
    ...
    - Add ScaleComponentCommand::allow_update ([`1d58e51`](https://github.com/wasmCloud/wasmCloud/commit/1d58e519160f0404954181dfc77af774e2ededcf))
    - Order HostInventory labels when serializing ([`d4880ab`](https://github.com/wasmCloud/wasmCloud/commit/d4880abaff6c86e27d4d4de0f2affd81dcbe5df5))
