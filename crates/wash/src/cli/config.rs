...
// NATS RPC connection configuration 
pub const WASMCLOUD_NATS_RPC_HOST: &str = "WASMCLOUD_NATS_RPC_HOST";
pub const WASMCLOUD_NATS_RPC_PORT: &str = "WASMCLOUD_NATS_RPCPORT";
pub const WASMCLOUD_NATS_RPC_JWT: &str = "WASMCLOUD_NATS_RPC_JWT";
pub const WASMCLOUD_NATS_RPC_SEED: &str = "WASMCLOUD_NATS_RPC_SEED";
pub const WASMCLOUD_RPC_TIMEOUT_MS: &str = "WASMCLOUD_RPC_TIMEOUT_MS";
pub const DEFAULT_RPC_TIMEOUT_MS: &str = "2000";
pub const WASMCLOUD_RPC_CREDSFILE: &str = "WASMCLOUD_RPC_CREDSFILE";
pub const WASMCLOUD_RPC_TLS: &str = "WASMCLOUD_RPC_TLS";
...
// Env's for backward capability
pub const WASMCLOUD_RPC_PORT: &str = WASMCLOUD_NATS_RPC_PORT;
pub const WASMCLOUD_RPC_HOST: &str = WASMCLOUD_NATS_RPC_HOST;
pub const WASMCLOUD_RPC_JWT: &str = WASMCLOUD_NATS_RPC_JWT;
pub const WASMCLOUD_RPC_SEED: &str = WASMCLOUD_NATS_RPC_SEED;

// NATS CTL connection configuration 
pub const WASMCLOUD_NATS_CTL_HOST: &str = "WASMCLOUD_NATS_CTL_HOST";
pub const WASMCLOUD_NATS_CTL_PORT: &str = "WASMCLOUD_NATS_CTL_PORT";
pub const WASMCLOUD_NATS_CTL_JWT: &str = "WASMCLOUD_NATS_CTL_JWT";
pub const WASMCLOUD_NATS_CTL_SEED: &str = "WASMCLOUD_NATS_CTL_SEED";
pub const WASMCLOUD_CTL_CREDSFILE: &str = "WASMCLOUD_CTL_CREDSFILE";
pub const WASMCLOUD_CTL_TLS: &str = "WASMCLOUD_CTL_TLS";
pub const WASMCLOUD_CTL_TLS_FIRST: &str = "WASMCLOUD_CTL_TLS_FIRST";
pub const WASMCLOUD_CTL_TLS_CA_FILE: &str = "WASMCLOUD_CTL_TLS_CA_FILE";
...
// Env's for backward capability
pub const WASMCLOUD_CTL_PORT: &str = WASMCLOUD_NATS_CTL_PORT;
pub const WASMCLOUD_CTL_HOST: &str = WASMCLOUD_NATS_CTL_HOST;
pub const WASMCLOUD_CTL_JWT: &str = WASMCLOUD_NATS_CTL_JWT;
pub const WASMCLOUD_CTL_SEED: &str = WASMCLOUD_NATS_CTL_SEED;
