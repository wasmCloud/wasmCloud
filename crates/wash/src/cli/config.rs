...
// NATS RPC connection configuration 
pub const WASMCLOUD_NATS_HOST: &str = "WASMCLOUD_NATS_HOST";
pub const WASMCLOUD_NATS_PORT: &str = "WASMCLOUD_NATS_PORT";
pub const WASMCLOUD_NATS_JWT: &str = "WASMCLOUD_NATS_JWT";
pub const WASMCLOUD_NATS_SEED: &str = "WASMCLOUD_NATS_SEED";
pub const WASMCLOUD_RPC_TIMEOUT_MS: &str = "WASMCLOUD_RPC_TIMEOUT_MS";
pub const DEFAULT_RPC_TIMEOUT_MS: &str = "2000";
pub const WASMCLOUD_RPC_CREDSFILE: &str = "WASMCLOUD_RPC_CREDSFILE";
pub const WASMCLOUD_RPC_TLS: &str = "WASMCLOUD_RPC_TLS";
...
pub const WASMCLOUD_RPC_PORT: &str = WASMCLOUD_NATS_PORT;
pub const WASMCLOUD_RPC_HOST: &str = WASMCLOUD_NATS_HOST;
pub const WASMCLOUD_RPC_JWT: &str = WASMCLOUD_NATS_JWT;
pub const WASMCLOUD_RPC_SEED: &str = WASMCLOUD_NATS_SEED;
...
// Env's for backward capability
pub const WASMCLOUD_CTL_PORT: &str = WASMCLOUD_NATS_PORT;
pub const WASMCLOUD_CTL_HOST: &str = WASMCLOUD_NATS_HOST;
pub const WASMCLOUD_CTL_JWT: &str = WASMCLOUD_NATS_JWT;
pub const WASMCLOUD_CTL_SEED: &str = WASMCLOUD_NATS_SEED;
