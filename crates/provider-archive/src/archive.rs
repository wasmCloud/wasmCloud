...
impl ProviderArchive {
    ...
    /// `try_load_target_from_file` method if you only want to load a single binary into memory.
    ...
    ///
    /// It is recommended to use this method when consuming a provider archive.
    /// Otherwise all binaries will be loaded into memory
